...
public class SchemaTransformerPresetsScreen extends AbstractPanelScreen {
    ...
    public SchemaTransformerPresetsScreen(Entrance entrance) {
    ...
    public SchemaTransformerPresetsScreen(Entrance entrance, Consumer<List<? extends Transformer>> consumer) {
        this(entrance);
    ...
    public void onReload() {
        ...
        this.addButton.setTooltip(
                Stream.concat(
                        switch (selectedType) {
                            case ARRAY -> Stream.of(Text.translate("dschema.transformer.add.tooltip.array.title"));
                            case MIRROR -> Stream.of(Text.translate("dschema.transformer.add.tooltip.mirror.title"));
                            case RADIAL -> Stream.of(Text.translate("dschema.transformer.add.tooltip.radial.title"));
                            case RANDOMIZER -> Stream.of(Text.translate("dschema.transformer.add.tooltip.random.title"));
                        },
                        TooltipHelper.wrapLines(getTypeface(), (switch (selectedType) {
                            case ARRAY -> Text.translate("dschema.transformer.add.tooltip.array.message");
                            case MIRROR -> Text.translate("dschema.transformer.add.tooltip.mirror.message");
                            case RADIAL -> Text.translate("dschema.transformer.add.tooltip.radial.message");
                            case RANDOMIZER -> Text.translate("dschema.transformer.add.tooltip.random.message");
