...
public class SchemaClipboardSettingsScreen extends AbstractPanelScreen {

    private final Consumer<ClipboardConfig> consumer;
    private ClipboardConfig originalConfig;
    private ClipboardConfig config;

    public SchemaClipboardSettingsScreen(Entrance entrance) {
        super(entrance, Text.translate("dschema.clipboard_settings.title"), PANEL_WIDTH_60, PANEL_HEIGHT_FULL);
