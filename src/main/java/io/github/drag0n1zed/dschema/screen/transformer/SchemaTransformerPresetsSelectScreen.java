...
public class SchemaTransformerPresetsSelectScreen extends AbstractPanelScreen {
    ...
    public SchemaTransformerPresetsSelectScreen(Entrance entrance, Consumer<Transformer> consumer) {
        super(entrance, Text.translate("dschema.transformer.template_select.title").withStyle(ChatFormatting.DARK_GRAY), PANEL_WIDTH_60, PANEL_HEIGHT_FULL);
    ...
    public void onCreate() {
        ...
        this.useTemplateButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.template_select.use_template"), button -> {
