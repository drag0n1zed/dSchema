...
public class SchemaItemPickerScreen extends AbstractPanelScreen {
    ...
    public SchemaItemPickerScreen(Entrance entrance, Predicate<Item> filter, Consumer<Item> consumer) {
        super(entrance, Text.translate("dschema.item.picker.title"), PANEL_WIDTH_60, PANEL_HEIGHT_FULL);
        this.filter = filter;
    ...
    public void onCreate() {
        ...
        this.searchEditBox.setHint(Text.translate("dschema.item.picker.search_hint"));
        ...
        this.cancelButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.item.picker.cancel"), button -> {
            detach();
        }).setBoundsGrid(getLeft(), getTop(), getWidth(), getHeight(), 0f, 0f, 0.5f).build());
        this.addButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.item.picker.add"), button -> {
            detach();
