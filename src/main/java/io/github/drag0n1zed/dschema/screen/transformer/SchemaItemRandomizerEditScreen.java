...
import io.github.drag0n1zed.universal.api.gui.tooltip.Palette;
...
import io.github.drag0n1zed.dschema.building.pattern.randomize.Randomizer;
import io.github.drag0n1zed.dschema.screen.item.SchemaItemPickerScreen;

public class SchemaItemRandomizerEditScreen extends AbstractPanelScreen {
    ...
    public SchemaItemRandomizerEditScreen(Entrance entrance, Consumer<ItemRandomizer> consumer, ItemRandomizer randomizer) {
        super(entrance, Text.translate("dschema.transformer.randomizer.edit.title"));
    ...
    public void onCreate() {
        ...
        this.sourceButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.source", randomizer.getSource().getDisplayName()), button -> {
            ...
            sourceButton.setMessage(Text.translate("dschema.transformer.randomizer.edit.source", this.randomizer.getSource().getDisplayName()));
            recreate();
        ...
        this.orderButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.order", randomizer.getOrder().getDisplayName()), button -> {
            ...
            orderButton.setMessage(Text.translate("dschema.transformer.randomizer.edit.order", this.randomizer.order().getDisplayName()));
        ...
        this.targetButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.target", randomizer.getTarget().getDisplayName()), button -> {
            ...
            targetButton.setMessage(Text.translate("dschema.transformer.randomizer.edit.target", this.randomizer.target().getDisplayName()));
        ...
        this.upButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.up"), button -> {
            if (entries.hasSelected()) {
                entries.moveUpSelected();
            }
        }).setBoundsGrid(getLeft(), getTop(), getWidth(), getHeight(), 1f, 0f, 0.25f).build());
        this.downButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.down"), button -> {
            if (entries.hasSelected()) {
                entries.moveDownSelected();
            }
        }).setBoundsGrid(getLeft(), getTop(), getWidth(), getHeight(), 1f, 0.25f, 0.25f).build());

        this.deleteButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.delete"), button -> {
            entries.deleteSelected();
        }).setBoundsGrid(getLeft(), getTop(), getWidth(), getHeight(), 1f, 0.5f, 0.25f).build());
        this.addButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.add"), button -> {
            new SchemaItemPickerScreen(
                    getEntrance(),
        ...
        this.cancelButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.cancel"), button -> {
            detach();
        }).setBoundsGrid(getLeft(), getTop(), getWidth(), getHeight(), 0f, 0f, 0.5f).build());
        this.saveButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.transformer.randomizer.edit.save"), button -> {
    ...
    public void onReload() {
        ...
        sourceTooltip.add(Text.translate("dschema.transformer.randomizer.edit.source.tooltip.title"));
        ...
        if (TooltipHelper.isSummaryButtonDown()) {
            sourceTooltip.add(Text.empty());
            sourceTooltip.addAll(TooltipHelper.wrapLines(getTypeface(), Text.translate("dschema.transformer.randomizer.edit.source.tooltip.message").withStyle(ChatFormatting.GRAY)));
            for (var source : ItemRandomizer.Source.values()) {
                sourceTooltip.add(Text.empty());
                sourceTooltip.addAll(TooltipHelper.wrapLines(getTypeface(), Text.text("").append(source.getDisplayName()).append("\n").withColor(Palette.GRAY_AND_WHITE.highlight().color()).append(Text.translate("dschema.transformer.randomizer.edit.source.tooltip.%s".formatted(source.getName())).withColor(Palette.GRAY_AND_WHITE.primary().color()))));
            }
        }
        this.sourceButton.setTooltip(sourceTooltip);

        var orderTooltip = new ArrayList<Text>();
        orderTooltip.add(Text.translate("dschema.transformer.randomizer.edit.order.tooltip.title"));
        ...
        if (TooltipHelper.isSummaryButtonDown()) {
            orderTooltip.add(Text.empty());
            orderTooltip.addAll(TooltipHelper.wrapLines(getTypeface(), Text.translate("dschema.transformer.randomizer.edit.order.tooltip.message").withStyle(ChatFormatting.GRAY)));
            for (var order : Randomizer.Order.values()) {
                orderTooltip.add(Text.empty());
                orderTooltip.addAll(TooltipHelper.wrapLines(getTypeface(), Text.text("").append(order.getDisplayName()).append("\n").withColor(Palette.GRAY_AND_WHITE.highlight().color()).append(Text.translate("dschema.transformer.randomizer.edit.order.tooltip.%s".formatted(order.getName())).withColor(Palette.GRAY_AND_WHITE.primary().color()))));
            }
        }
        this.orderButton.setTooltip(orderTooltip);

        var targetTooltip = new ArrayList<Text>();
        targetTooltip.add(Text.translate("dschema.transformer.randomizer.edit.target.tooltip.title"));
        ...
        if (TooltipHelper.isSummaryButtonDown()) {
            targetTooltip.add(Text.empty());
            targetTooltip.addAll(TooltipHelper.wrapLines(getTypeface(), Text.translate("dschema.transformer.randomizer.edit.target.tooltip.message").withStyle(ChatFormatting.GRAY)));
            for (var target : Randomizer.Target.values()) {
                targetTooltip.add(Text.empty());
                targetTooltip.addAll(TooltipHelper.wrapLines(getTypeface(), Text.text("").append(target.getDisplayName()).append("\n").withColor(Palette.GRAY_AND_WHITE.highlight().color()).append(Text.translate("dschema.transformer.randomizer.edit.target.tooltip.%s".formatted(target.getName())).withColor(Palette.GRAY_AND_WHITE.primary().color()))));
            }
        }
