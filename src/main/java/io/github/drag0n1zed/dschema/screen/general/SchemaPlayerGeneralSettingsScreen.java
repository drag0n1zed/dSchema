...
public class SchemaPlayerGeneralSettingsScreen extends AbstractPanelScreen {
    ...
    public SchemaPlayerGeneralSettingsScreen(Entrance entrance, PlayerInfo playerInfo, ConstraintConfig config, BiConsumer<PlayerInfo, ConstraintConfig> consumer) {
        super(entrance, Text.translate("dschema.general_settings.title"), PANEL_WIDTH_60, PANEL_HEIGHT_FULL);
...
//        bindEntry(
//                entries.addSwitchEntry(Text.translate("dschema.general_settings.use_commands"), null, null, null),
//                value -> {
...
//        );
        ...
        bindEntry(
                entries.addSwitchEntry(Text.translate("dschema.general_settings.allow_use_mod"), null, null, null),
                (value) -> {
        ...
        bindEntry(
                entries.addSwitchEntry(Text.translate("dschema.general_settings.allow_break_blocks"), null, null, null),
                (value) -> {
        ...
        bindEntry(
                entries.addSwitchEntry(Text.translate("dschema.general_settings.allow_place_blocks"), null, null, null),
                (value) -> {
        ...
        bindEntry(
                entries.addSwitchEntry(Text.translate("dschema.general_settings.allow_interact_blocks"), null, null, null),
                (value) -> {
        ...
        bindEntry(
                entries.addSwitchEntry(Text.translate("dschema.general_settings.allow_copy_paste_structures"), null, null, null),
                (value) -> {
        ...
        bindEntry(
                entries.addSwitchEntry(Text.translate("dschema.general_settings.use_proper_tools"), null, null, null),
                (value) -> {
        ...
        bindEntry(
                entries.addIntegerEntry(Text.translate("dschema.general_settings.max_reach_distance"), null, 0, ConstraintConfig.MAX_REACH_DISTANCE_RANGE_START, ConstraintConfig.MAX_REACH_DISTANCE_RANGE_END, 8, null),
                (value) -> {
        ...
        bindEntry(
                entries.addIntegerEntry(Text.translate("dschema.general_settings.max_block_break_volume"), null, 0, ConstraintConfig.MAX_BLOCK_BREAK_VOLUME_RANGE_START, ConstraintConfig.MAX_BLOCK_BREAK_VOLUME_RANGE_END, 100, null),
                (value) -> {
        ...
        bindEntry(
                entries.addIntegerEntry(Text.translate("dschema.general_settings.max_block_place_volume"), null, 0, ConstraintConfig.MAX_BLOCK_PLACE_VOLUME_RANGE_START, ConstraintConfig.MAX_BLOCK_PLACE_VOLUME_RANGE_END, 100, null),
                (value) -> {
        ...
        bindEntry(
                entries.addIntegerEntry(Text.translate("dschema.general_settings.max_block_interact_volume"), null, 0, ConstraintConfig.MAX_BLOCK_INTERACT_VOLUME_RANGE_START, ConstraintConfig.MAX_BLOCK_INTERACT_VOLUME_RANGE_END, 100, null),
                (value) -> {
        ...
        bindEntry(
                entries.addIntegerEntry(Text.translate("dschema.general_settings.max_structure_copy_paste_volume"), null, 0, ConstraintConfig.MAX_STRUCTURE_COPY_PASTE_VOLUME_RANGE_START, ConstraintConfig.MAX_STRUCTURE_COPY_PASTE_VOLUME_RANGE_END, 100, null),
                (value) -> {
        ...
        bindEntry(
                entries.addTab(Text.translate("dschema.general_settings.whitelisted_items"), null, null, null, (entry, value) -> {
                    entry.getButton().setOnPressListener(button1 -> {
                        new SchemaItemsScreen(getEntrance(), Text.translate("dschema.general_settings.whitelisted_items"), value.stream().map(Item::fromId).toList(), (value1) -> {
                            entry.setItem(value1.stream().map(Item::getId).toList());
                        }).attach();
                    });
                    entry.getButton().setMessage(Text.translate("dschema.general_settings.items", value == null ? null : value.size()));
                }),
                (value) -> {
        ...
        bindEntry(
                entries.addTab(Text.translate("dschema.general_settings.blacklisted_items"), null, null, null, (entry, value) -> {
                    entry.getButton().setOnPressListener(button1 -> {
                        new SchemaItemsScreen(getEntrance(), Text.translate("dschema.general_settings.blacklisted_items"), value.stream().map(Item::fromId).toList(), (value1) -> {
                            entry.setItem(value1.stream().map(Item::getId).toList());
                        }).attach();
                    });
                    entry.getButton().setMessage(Text.translate("dschema.general_settings.items", value == null ? null : value.size()));
