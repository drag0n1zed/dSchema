...
import io.github.drag0n1zed.dschema.screen.transformer.SchemaItemRandomizerEditScreen;
import io.github.drag0n1zed.dschema.screen.transformer.SchemaTransformerEditScreen;
import io.github.drag0n1zed.dschema.screen.transformer.SchemaTransformerPresetsSelectScreen;
import io.github.drag0n1zed.dschema.screen.transformer.TransformerList;

public class SchemaPatternScreen extends AbstractPanelScreen {
    ...
    public SchemaPatternScreen(Entrance entrance) {
        super(entrance, Text.translate("dschema.pattern.title").withStyle(ChatFormatting.DARK_GRAY));
    ...
    public void onCreate() {
        ...
        this.enableButton = addWidget(Button.builder(getEntrance(), pattern.enabled() ? Text.translate("dschema.pattern.button.disable") : Text.translate("dschema.pattern.button.enable"), button -> {
        ...
        this.addButton = addWidget(Button.builder(getEntrance(), Text.translate("dschema.button.add"), button -> {
            new SchemaTransformerPresetsSelectScreen(
                    getEntrance(),
                    transformer -> {
    ...
    private void editTransformer(Transformer transformer) {
        switch (transformer.getType()) {
            case ARRAY, MIRROR, RADIAL -> {
                new SchemaTransformerEditScreen(
                        getEntrance(),
                        result -> {
                            if (entries.hasSelected()) {
