package io.github.drag0n1zed.dschema.screen.render;
...
public class SchemaRenderSettingsScreen extends AbstractPanelScreen {
    ...
    public SchemaRenderSettingsScreen(Entrance entrance) {
        super(entrance, Text.translate("dschema.render_settings.title"), PANEL_WIDTH_60, PANEL_HEIGHT_FULL);
