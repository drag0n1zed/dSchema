package io.github.drag0n1zed.dschema.building.pattern.mirror;
...
import io.github.drag0n1zed.dschema.building.operation.batch.GroupOperation;
...
public record MirrorTransformer(UUID id, Text name, Vector3d position, Axis axis, int size) implements Transformer {
    ...
    public Text getName() {
        ...
        return Text.translate("dschema.transformer.mirror.no_name");
    }
