...
import io.github.drag0n1zed.dschema.building.operation.batch.DeferredBatchOperation;
...
public record ItemRandomizer(UUID id, Text name, Order order, Target target, Source source, Collection<Chance<Item>> chances) implements Randomizer<Item> {
    ...
    public static final ItemRandomizer RANDOM_INVENTORY = ItemRandomizer.create(Text.translate("dschema.transformer.randomizer.item.random_inventory"), Order.RANDOM, Target.SINGLE,  Source.INVENTORY, Collections.emptyList());
    public static final ItemRandomizer RANDOM_HOTBAR = ItemRandomizer.create(Text.translate("dschema.transformer.randomizer.item.random_hotbar"), Order.RANDOM, Target.SINGLE,  Source.HOTBAR, Collections.emptyList());
    public static final ItemRandomizer RANDOM_HANDS = ItemRandomizer.create(Text.translate("dschema.transformer.randomizer.item.random_hands"), Order.RANDOM, Target.SINGLE,  Source.HANDS, Collections.emptyList());

    public static final ItemRandomizer SEQUENCE_INVENTORY = ItemRandomizer.create(Text.translate("dschema.transformer.randomizer.item.sequence_inventory"), Order.SEQUENCE, Target.SINGLE,  Source.INVENTORY, Collections.emptyList());
    public static final ItemRandomizer SEQUENCE_HOTBAR = ItemRandomizer.create(Text.translate("dschema.transformer.randomizer.item.sequence_hotbar"), Order.SEQUENCE, Target.SINGLE,  Source.HOTBAR, Collections.emptyList());
    public static final ItemRandomizer SEQUENCE_HANDS = ItemRandomizer.create(Text.translate("dschema.transformer.randomizer.item.sequence_hands"), Order.SEQUENCE, Target.SINGLE,  Source.HANDS, Collections.emptyList());
    ...
    private static Text name(String key) {
        return Text.translate("dschema.transformer.randomizer.item.example.%s".formatted(key));
    }
    ...
    public Text getName() {
        ...
        switch (getSource()) {
            case INVENTORY -> {
                switch (getOrder()) {
                    case SEQUENCE -> {
                        return Text.translate("dschema.transformer.randomizer.item.sequence_inventory");
                    }
                    case RANDOM -> {
                        return Text.translate("dschema.transformer.randomizer.item.random_inventory");
                    }
                }
            }
            case HOTBAR -> {
                switch (getOrder()) {
                    case SEQUENCE -> {
                        return Text.translate("dschema.transformer.randomizer.item.sequence_hotbar");
                    }
                    case RANDOM -> {
                        return Text.translate("dschema.transformer.randomizer.item.random_hotbar");
                    }
                }
            }
            case HANDS -> {
                switch (getOrder()) {
                    case SEQUENCE -> {
                        return Text.translate("dschema.transformer.randomizer.item.sequence_hands");
                    }
                    case RANDOM -> {
                        return Text.translate("dschema.transformer.randomizer.item.random_hands");
                    }
                }
            }
            case CUSTOMIZE -> {
                if (getChances().isEmpty()) {
                    return Text.translate("dschema.transformer.randomizer.item.empty");
                }
                switch (getOrder()) {
                    case SEQUENCE -> {
                        return Text.translate("dschema.transformer.randomizer.item.sequence_customized");
                    }
                    case RANDOM -> {
                        return Text.translate("dschema.transformer.randomizer.item.random_customized");
                    }
                }
            }
        }
...
//        descriptions.add(Text.text("Source ").append(source.getDisplayName()));
    ...
    public enum Source {
        ...
        public Text getDisplayName() {
            return Text.translate("dschema.transformer.randomizer.source.%s".formatted(name));
        }
