...
public record Context(
    ...
    public record Extras(
            ...
            io.github.drag0n1zed.dschema.building.operation.block.Extras extras,
            GameMode gameMode,
            long seed,
        ...
        public Extras(Player player) {
            this(player.getWorld().getDimensionId().location(), io.github.drag0n1zed.dschema.building.operation.block.Extras.get(player), player.getGameMode(), new Random().nextLong(), new InventorySnapshot(player.getInventory()));
        }
    }
