package io.github.drag0n1zed.dschema.building.pattern.array;
...
import io.github.drag0n1zed.universal.api.math.BoundingBox3i;
...
public record ArrayTransformer(UUID id, Text name, Vector3i offset, int count) implements Transformer {
    ...
    public Text getName() {
        ...
        return Text.translate("dschema.transformer.array.no_name");
    }
