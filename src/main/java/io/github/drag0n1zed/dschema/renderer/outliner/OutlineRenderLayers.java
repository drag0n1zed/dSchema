package io.github.drag0n1zed.dschema.renderer.outliner;
...
import io.github.drag0n1zed.universal.api.renderer.RenderLayers;
import io.github.drag0n1zed.universal.api.renderer.VertexFormats;
import io.github.drag0n1zed.universal.api.renderer.programs.RenderState;

public abstract class OutlineRenderLayers extends RenderLayers {

    public static final ResourceLocation BLANK_TEXTURE_LOCATION = ResourceLocation.of("dschema", "textures/misc/blank.png");
    public static final ResourceLocation CHECKERED_TEXTURE_LOCATION = ResourceLocation.of("dschema", "textures/misc/checkerboard.png");
    public static final ResourceLocation CHECKERED_HIGHLIGHT_TEXTURE_LOCATION = ResourceLocation.of("dschema", "textures/misc/checkerboard_highlight.png");

    public static final ResourceLocation CHECKERED_THIN_TEXTURE_LOCATION = ResourceLocation.of("dschema", "textures/misc/checkerboard_thin_64.png");
    public static final ResourceLocation CHECKERED_CUTOUT_TEXTURE_LOCATION = ResourceLocation.of("dschema", "textures/misc/checkerboard_cutout.png");
    public static final ResourceLocation SELECTION_TEXTURE_LOCATION = ResourceLocation.of("dschema", "textures/misc/selection_64.png");
