...
//            getEntrance().getChannel().sendPacket(PlayerBuildTooltipPacket.build(result), player);
    ...
    public void undo(Player player) {
        ...
        try {
            ...
            player.sendMessage(Schema.getMessage(countText.append(" ").append(Text.translate("dschema.message.history.server.undo", buildStateText, affectedText))));
        } catch (EmptyStackException e) {
            getEntrance().getChannel().sendPacket(PlayerBuildTooltipPacket.nothingToUndo(), player);
            var countText = Text.text("[").append(String.valueOf(stack.undoSize())).append("/").append(String.valueOf(stack.redoSize())).append("]").withStyle(ChatFormatting.WHITE);
            player.sendMessage(Schema.getMessage(countText.append(" ").append(Text.translate("dschema.history.nothing_to_undo"))));
        }
    }
    ...
    public void redo(Player player) {
        ...
        try {
            ...
            var affectedText = Text.text("[").append(String.valueOf(result.getAffectedBlockCount())).append("]").withStyle(ChatFormatting.AQUA);
            player.sendMessage(Schema.getMessage(countText.append(" ").append(Text.translate("dschema.message.history.server.redo", buildStateText, affectedText))));
        } catch (EmptyStackException e) {
            getEntrance().getChannel().sendPacket(PlayerBuildTooltipPacket.nothingToRedo(), player);
            var countText = Text.text("[").append(String.valueOf(stack.undoSize())).append("/").append(String.valueOf(stack.redoSize())).append("]").withStyle(ChatFormatting.WHITE);
            player.sendMessage(Schema.getMessage(countText.append(" ").append(Text.translate("dschema.history.nothing_to_redo"))));
        }
    }
