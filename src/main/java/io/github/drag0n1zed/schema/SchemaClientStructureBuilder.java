...
import io.github.drag0n1zed.schema.building.BuildStage;
...
import io.github.drag0n1zed.schema.building.operation.block.BlockOperationResult;
...
import io.github.drag0n1zed.schema.renderer.outliner.OutlineRenderLayers;
import io.github.drag0n1zed.schema.screen.wheel.AbstractWheelScreen;
...
public final class SchemaClientStructureBuilder extends StructureBuilder {
    ...
    public boolean checkPermission(Player player) {
        ...
        if (!isPermissionGranted(player)) {
            player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.no_permission")));
            return false;
        }
        return true;
    }
    ...
    public EventResult onPlayerInteract(Player player, InteractionType type, InteractionHand hand) {
        ...
        var buildResult = updateContext(player, context -> {
            ...
            if (interaction.getTarget() == Interaction.Target.MISS) {
                ...
                player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.cannot_reach_target").append(message)));
//                player.sendClientMessage(Text.translate("effortless.message.building.client.cannot_reach_target").append(message), true);
            ...
            if (interaction.getTarget() == Interaction.Target.ENTITY) {
                player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.cannot_reach_entity")));
//                player.sendClientMessage(Text.translate("effortless.message.building.client.cannot_reach_entity"), true);
            ...
            if (context.isBuilding() && context.buildState() != state) {
                switch (context.buildState()) {
                    case BREAK_BLOCK -> player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.block_breaking_canceled")));
                    case PLACE_BLOCK -> player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.block_placing_canceled")));
                    case INTERACT_BLOCK -> player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.block_interacting_canceled")));
                    case COPY_STRUCTURE -> player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.structure_copying_canceled")));
                    case PASTE_STRUCTURE -> player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.structure_pasting_canceled")));
                }
                return context.newInteraction();
            }
            if (context.buildState() == BuildState.IDLE && state == BuildState.COPY_STRUCTURE && !context.clipboard().snapshot().isEmpty()) {
                player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.structure_pasting_canceled")));
//                player.sendClientMessage(Text.translate("effortless.message.building.client.structure_pasting_canceled"), true);
            ...
            if (!context.withBuildState(state).hasPermission()) {
                if (state == BuildState.BREAK_BLOCK) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.no_block_break_permission")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.no_block_break_permission"), true);
                ...
                if (state == BuildState.PLACE_BLOCK) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.no_block_place_permission")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.no_block_place_permission"), true);
                ...
                if (state == BuildState.INTERACT_BLOCK) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.no_block_interact_permission")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.no_block_interact_permission"), true);
                ...
                if (state == BuildState.COPY_STRUCTURE) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.no_structure_copy_permission")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.no_structure_copy_permission"), true);
                ...
                if (state == BuildState.PASTE_STRUCTURE) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.no_structure_paste_permission")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.no_structure_paste_permission"), true);
            ...
            if (!nextContext.isVolumeInBounds()) {
                if (nextContext.buildState() == BuildState.BREAK_BLOCK) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.block_break_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxVolume())).append(")")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.block_break_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getBoxVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxBoxVolume())).append(")"), true);
                ...
                if (nextContext.buildState() == BuildState.PLACE_BLOCK) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.block_place_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxVolume())).append(")")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.block_place_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getBoxVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxBoxVolume())).append(")"), true);
                ...
                if (nextContext.buildState() == BuildState.INTERACT_BLOCK) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.block_interact_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxVolume())).append(")")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.block_interact_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getBoxVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxBoxVolume())).append(")"), true);
                ...
                if (nextContext.buildState() == BuildState.COPY_STRUCTURE) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.structure_copy_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxVolume())).append(")")));
//                    player.sendClientMessage(Text.translate("effortless.message.building.client.structure_copy_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getBoxVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxBoxVolume())).append(")"), true);
                ...
                if (nextContext.buildState() == BuildState.PASTE_STRUCTURE) {
                    player.sendMessage(Schema.getSystemMessage(Text.translate("effortless.message.building.server.structure_paste_volume_too_large").append(" (").append(Text.text(String.valueOf(nextContext.getVolume())).withStyle(ChatFormatting.RED)).append("/").append(String.valueOf(nextContext.getMaxVolume())).append(")")));
