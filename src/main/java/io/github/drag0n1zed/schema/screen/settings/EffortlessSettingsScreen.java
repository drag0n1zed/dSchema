...
import io.github.drag0n1zed.schema.SchemaClientConfigStorage;
...
import io.github.drag0n1zed.schema.screen.builer.EffortlessBuilderSettingsScreen;
import io.github.drag0n1zed.schema.screen.general.EffortlessGlobalGeneralSettingsScreen;
    ...
    public void onReload() {
        ...
        if (TooltipHelper.isSummaryButtonDown()) {
            ...
            constraintTooltip.addAll(
                    TooltipHelper.wrapLines(getTypeface(), Text.translate("effortless.general_settings.tooltip", Text.text("[%s]".formatted(SchemaConfigStorage.CONFIG_NAME)).withStyle(ChatFormatting.GOLD)).withStyle(ChatFormatting.GRAY))
            );
        }
        ...
        if (TooltipHelper.isSummaryButtonDown()) {
            ...
            builderTooltip.addAll(
                    TooltipHelper.wrapLines(getTypeface(), Text.translate("effortless.builder_settings.tooltip", Text.text("[%s]".formatted(SchemaClientConfigStorage.CONFIG_NAME)).withStyle(ChatFormatting.GOLD)).withStyle(ChatFormatting.GRAY))
            );
        }
